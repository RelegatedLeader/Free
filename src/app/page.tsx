...
const features = [
  {
    ...
    description:
      "Direct brain-device connection for enhanced therapy and personal visualization.",
  ...
  },
  {
    ...
    title: "Privacy First",
    description:
      "Quantum-powered encryption. Your data is yours. Never sold, always protected.",
  ...
  },
  {
    ...
    description:
      "Advanced quantum computing for data restoration and potential future recovery.",
  ...
  },
  {
    ...
    description:
      "Understand yourself deeper with advanced visualization of your patterns.",
...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16 space-y-3 sm:space-y-4">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Built with intention. Designed for freedom. Powered by quantum
              security.
            </p>
          </div>
      ...
      <section
        id="privacy"
        className="py-16 sm:py-24 bg-gradient-to-b from-white dark:from-gray-950 to-brand-50/30 dark:to-gray-900 transition-colors duration-300"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-6 sm:space-y-8">
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-400">
              We believe in complete privacy and data ownership. Your personal
              data is never sold.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-10 sm:mt-12">
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                Military-grade quantum encryption protects your data.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                Data automatically deleted after each session unless saved.
              </p>
            </div>
            <div className="space-y-4">
              <div className="text-3xl sm:text-4xl">🙏</div>
              ...
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                We don't manipulate your choices—you return by will.
              </p>
            </div>
          </div>
        </div>
